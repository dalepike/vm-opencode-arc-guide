...
# Copy superpowers AGENTS.md into working directory if none exists
if [ ! -f /work/AGENTS.md ]; then
  cp /opt/harness/AGENTS.md /work/AGENTS.md
  echo "[superpowers] Installed AGENTS.md (design-plan-implement-verify workflow)"
fi

echo ""
echo "╔══════════════════════════════════════════════════╗"
echo "║  OpenCode + VT ARC  (superpowers mode)          ║"
echo "║  AI coding assistant on Virginia Tech's network  ║"
echo "║                                                  ║"
echo "║  Methodology: Design -> Plan -> Implement ->     ║"
echo "║  Verify. TDD required. No skipping phases.       ║"
echo "╚══════════════════════════════════════════════════╝"
echo ""
